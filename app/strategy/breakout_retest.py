...
class BreakoutRetestStrategy:
    ...
    def evaluate(self,regime,candles,decision_id,symbol,timeframe,current_price=None,snapshot=None):
        ...
        self.last_trace={'accepted':True,'reason':'setup_valid','score':score,'direction':direction.value,'atr_pct':ap,'adx_5m':a5,'adx_15m':d15['adx'],'adx_1h':d1['adx'],'rvol':rv,'sl_pct':sl_pct,'tp_pct':tp_pct,'entry':p,'stop':stop,'target':target}
